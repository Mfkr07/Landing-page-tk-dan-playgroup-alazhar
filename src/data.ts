...
export const BRAND_DATA = {
  ...
  subTagline: "TK dan Playgroup terbaik di Muara Enim — pilihan utama pendidikan anak usia dini (PAUD) demi fondasi masa depan gemilang dengan lingkungan belajar ramah anak, berlimpah kasih sayang, dan metode bermain yang seru.",
  history: "Berdiri di bawah Lembaga Pendidikan Islam Al-Azzhar, yayasan kami merupakan salah satu TK dan Playgroup terkemuka di Muara Enim yang berdedikasi tinggi menyajikan pendidikan karakter anak usia dini (PAUD) berkualitas. Kami percaya bahwa usia emas (golden age) adalah momentum krusial yang harus diisi dengan pembelajaran penuh sukacita, penanaman iman, dan stimulasi potensi minat bakat yang berimbang.",
